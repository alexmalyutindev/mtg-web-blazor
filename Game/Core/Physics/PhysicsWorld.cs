    ...
    public void Add(Scene scene)
    {
        foreach (var entity in scene.Root)
        {
            ...
            if (staticBody != null)
            {
                ...
                var position = entity.Transform.Position + Vector3.Transform(staticBody.Offset, rotation);
                staticBody.Description = new StaticDescription(position, rotation, staticBody.ShapeId);
